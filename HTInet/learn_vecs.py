...
def learn_embeddings(walks):
    ...
    model = Word2Vec(sentences, size=args.dimensions, window=args.window_size, min_count=0, workers=args.workers, iter=args.iter, negative=0, sg=1)
...
def emb_main(args):
    args.input = 'n2vnew_1/nodewalks.txt'
    args.output = 'n2vnew_1/emb.txt'
    args.model = 'n2vnew_1/emb.model'
    args.dimensions = 64
    args.iter = 5
    args.window_size = 10
    args.workers = 6
